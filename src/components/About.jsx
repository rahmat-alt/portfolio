  ...
  const data = [
    {
      ...
      description: "HTML, CSS, JavaScript PHP, Laravel",
    },
    {
      name: "Education",
      icon1: "./assets/edu-icon.png",
      icon2: "./assets/edu-icon-dark.png",
      description: "Universitas Negeri Padang, Geografi",
    },
    {
      name: "Projects",
      ...
      <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
        ...
        <div className="flex-1">
          <p className="mb-10 max-w-2xl font-Ovo">
            I am a Web Developer with a background in Geography from Universitas
            Negeri Padang and over two years of professional experience in web
            development. I specialize in building responsive, user-friendly
            websites and web applications, with a strong focus on front-end
            development. My academic background has strengthened my analytical
            thinking and problem-solving skills, which I apply to delivering
            efficient and well-structured digital solutions.
          </p>
